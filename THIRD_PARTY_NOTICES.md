...
Swoop TV v0.3.1 does not bundle an mpv binary inside this source ZIP. On first Windows-native launch, the bootstrap downloads the pinned Windows x64 CI package for **mpv 0.41.0** from the official `mpv-player/mpv` GitHub release and verifies its SHA-256 hash before extraction.
