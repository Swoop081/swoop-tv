# Swoop TV Cloudflare Connection + Metadata Service v0.1.13
...
3. Owner-managed Swoop TV discovery charts. With `MDBLIST_API_KEY`, a curated allow-list of Snoak's daily MDBList feeds is the primary ranking layer for Top 100, Trending, New & Hot and selected genre rows; TMDb and MDBList official charts remain fallback signals.
