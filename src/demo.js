...
export const demoCatalog = [
  ...['Swoop TV News','Arena Sports','World Football','Cinema One','Discovery World','Kids Central','Retro TV','Music Live'].map((name,i)=>({id:`demo:live:${i}`,providerId:'demo',source:'demo',kind:'live',name,group:i<3?'Live & Sports':'Entertainment',logo:'',tvgId:'',streamUrl:'',demoColor:grad(i)})),
